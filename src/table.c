...
void table_t_resize_and_map(table_t *t) { printf("Not implemented\n"); }
...
uint table_t_get_capacity(table_t *t) { return t->capacity; }

uint table_t_get_size(table_t *t) { return t->size; }
